...
class Tac3DPublisher(Node):
    ...
    def __init__(self):
        ...
        # 发布器定义
        self.publisher_positions = self.create_publisher(Image, 'positions_r', 10)  # P数据 (Image)
        self.publisher_displacements = self.create_publisher(Image, 'displacements_r', 10)  # D数据 (Image)
        self.publisher_forces = self.create_publisher(Image, 'forces_r', 10)  # F数据 (Image)
